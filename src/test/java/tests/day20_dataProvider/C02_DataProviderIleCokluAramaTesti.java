...
public class C02_DataProviderIleCokluAramaTesti {
    ...
    /*
        ...
        tek tek yollayan ozel bir method'dur.

        boylece kac farkli data varsa
        her biri icin Test Method'u tekrar tekrar calistirilir
        ve panelde tek bir method calistirma yerine kac kez tekrar edildiyse
        o kadar test calistirildigi raporlanir.

        Data provider kullanmak icin
     1- test method'unu disaridan parametre gelecek sekilde olusturun
     2- test method'una disardan data'larini yollayacak
    ...
    public static Object[][] urunIsimDataProvideri() {
        ...
        String[][] aranacakUrunlerArrayi = {{"phone"}, {"dress"}, {"java"}, {"samsung"}, {"nutella"}, {"apple"}, {"cokoprens"}};
